...
def evaluate():
    lable_path = "E:\\Experiment data\\data-for-detection\\Landsat\\Test\\single-mask\\"
    result_path = "E:\\Experiment data\data-for-detection\\Landsat\\Test\\mask1\\"
    ...
    for imgname in imgsname:
        ...
        img_gt = load_img(lable_path + name, grayscale=True)
